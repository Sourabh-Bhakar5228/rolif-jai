    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
      ...
      <div className="md:w-1/2 space-y-6">
        <h2 className="text-4xl font-bold text-main-color leading-snug">
          ...
          <span className="text-gray-600 text-3xl"> Luxurious Furniture</span>
        </h2>
        ...
        <button className="px-3 py-1 cursor-pointer text-[14px] bg-red-300 text-white font-medium rounded-lg shadow-md hover:bg-indigo-700 transition-all">
          Explore Collection
        </button>
      </div>

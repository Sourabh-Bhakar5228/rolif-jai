...
const TilesAbout = ({
  ...
  return (
    <div className="relative bg-gray-100 py-16 px-6 md:px-16 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          <p className="text-gray-600 text-main-size leading-relaxed">
          ...
          <button className="relative px-6 text-[15px] py-2 font-medium text-white bg-blue-600 rounded-lg group overflow-hidden">
